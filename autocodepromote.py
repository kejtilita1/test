...
class AutoCodePromote(object):
    ...
    def promote_change(self, onChangeSourceHandlerFunc, target_branch, commit_msg, ff_ancestor_branch=None,
                       tmp_banch_prefix="tmp"):
        """
        ...
        for i in range(0, self.promote_retry_count):
            ...
            try:
                ...
                if len(modfiles) > 0:
                    ...
                    logger.error(
                        "The file changes completed by the handler did not result in any file modifications.  This may be expected behavior.")
