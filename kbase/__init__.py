##
# @author: Author: Ofer Levy
# @note: This file makes this folder a Python package and resolves any
#     imports from TWIDL tree. Any module in this folder that imports from TWIDL
#     tree should include a first line import "import __init__", and use explicit
#     import statement. For example, "import Intel.vendspec" 
